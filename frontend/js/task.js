...
async function fetchTasks() {
    ...
    try {
        const response = await fetch('https://app-todo-list.onrender.com/tasks', {
            method: 'GET',
            headers: {
...
async function completeTask(taskId) {
    ...
    try {
        const response = await fetch(`https://app-todo-list.onrender.com/tasks/${taskId}/complete`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}` // Incluyendo el token JWT
...
async function editTask(event) {
    ...
    try {
        const response = await fetch(`https://app-todo-list.onrender.com/tasks/${taskId}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}` // Incluyendo el token JWT
